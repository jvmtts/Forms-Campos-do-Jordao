...
const BASIN_ENDPOINT = 'https://usebasin.com/f/4c202af3081c'
        ...
        <form className="rounded-b-3xl border-x border-b border-[#ded0c2] bg-[#fffdf9] p-5 shadow-[0_26px_80px_rgba(45,33,27,0.09)] sm:p-9 lg:p-14" noValidate onSubmit={(event) => event.preventDefault()}>
          {step === 0 && (
            <div>
              ...
              <CompanionsSection companions={values.acompanhantes} errors={errors} accent="#9a6230" onAdd={addCompanion} onRemove={removeCompanion} onChange={updateCompanion} />
            </div>
          )}
